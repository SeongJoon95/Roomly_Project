...
public class BusinessNumberCheckController {
    ...
    public ResponseEntity<ResponseDto> getBusinessInfo(
        ...
        try {
            ...
            String encodedUrl = "http://api.odcloud.kr/api/nts-businessman/v1/validate?serviceKey=4RhJzolTye%2FzqK0e0Pd1RKdonymhZcHkqj7DHKRPFVURbF74YQUUjtRguJxViXqJgfEQ%2B4dIuq%2FyO%2Fq8n6WvIg%3D%3D";

package com.roomly.roomly.controller.host;
...
import com.roomly.roomly.service.host.UseInfomationService;
...
public class AccommodationController {
    ...
    public ResponseEntity<ResponseDto> postAccommodation(
        @RequestBody @Valid ResgistAccomodationDto reqeustBody){

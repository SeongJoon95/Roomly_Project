package com.roomly.roomly.service.host.implement;
...
import com.roomly.roomly.dto.request.accommodation.ResgistAccomodationDto;
...
import com.roomly.roomly.service.host.AccommodationService;
...
public class AccommodationServiceImplement implements AccommodationService {
    ...
    // 숙소 등록 메서드
    @Override
    public ResponseEntity<ResponseDto> postAccommodation(ResgistAccomodationDto resgistAccomodation) {
        
        // String accommodationName = resgistAccomodation.getAccommodationReqeustDto().getAccommodationName();
        String accommodationName = resgistAccomodation.getAccommodationName();

        try {

            // 승인받은 계정여부확인
            // String host = resgistAccomodation.getAccommodationReqeustDto().getHostId();
            String host = resgistAccomodation.getHostId();
            ...
            String accommdationMainImage = resgistAccomodation.getAccommodationMainImage();
            ...
            AccommodationEntity accommodationEntity = new AccommodationEntity(resgistAccomodation);

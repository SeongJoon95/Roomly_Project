package com.roomly.roomly.config;
...
import com.roomly.roomly.service.auth.implement.OAuth2UserServiceImplement;
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception{
        ...
        security
            ...
            .authorizeHttpRequests(request -> request
                ...
                "/api.odcloud.kr/api/**",
                "/api/roomly/auth/common/**",
                "/api/roomly/auth/guest/**", 
                "/api/roomly/auth/host/**",
                "/api/roomly/file/**",
                "/api.roomly/admin/**",
                "/api/roomly/reservation/**"
                ).permitAll()
            ...
            .oauth2Login(oauth2 -> oauth2
                ...
                .authorizationEndpoint(endpoint -> endpoint.baseUri("/api/v1/auth/guest/sns-sign-in"))

...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler{
    ...
    public void onAuthenticationSuccess(
        ...
        // 회원가입 O
        if(existed){
            String accessToken = (String) attributes.get("guestAccessToken");
            response.sendRedirect("http://localhost:3000/sns-success?guestAccessToken=" + accessToken + "&expiration=36000");
            System.out.println("guestAccessToken @@@@@@@@@@@@@@@@" + attributes.get("guestAccessToken"));

...
public interface GuestRepository extends JpaRepository<GuestEntity, String> {
    ...
    GuestEntity findByGuestNameAndGuestTelNumber(String guestName, String guestTelNumber);
    GuestEntity findByGuestTelNumber(String guestTelNumber);
    GuestEntity findByGuestIdAndGuestTelNumber(String id, String telNumber);

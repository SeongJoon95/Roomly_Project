...
export default function Add({ titletext, username, activite, hostId }: Props) {
    ...
    const onClickMoveAdd = () => {
        ...
        navigator('/mypagehost/enrollment',{ state: {hostId} })
    }

  ...
  const handleChangebooking = () => {
    if (cookies.guestAccessToken) {
      ...
      navigator(
        ...
        { state: { imageSrc: accommodation.accommodationMainImage[0], price: room.roomPrice, checkInTime: urlStart, checkOutTime: urlEnd, personnelCount: urlCount, accommodationName:accommodation.accommodationName,
          roomName: room.roomName, roomType: urlRoom, roomId: room.roomId }
    });
    } else {
